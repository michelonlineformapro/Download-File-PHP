...
<?php
//Si le formulaire est soumis (appel de attribut name de input type submit
...
$header.= 'Content-Type:text/html; charset="utf-8"'."\n";
$header.= 'Content-Transfert-Encoding: 8bit';
$dest = "michel.onlineformapro@gmail.com";
$sujet = "Email de test";
$corp = "Salut ceci est un email de test envoyer par un script PHP";
$header .= "From: michel.onlineformapro@gmail.com";


if (mail($dest, $sujet, $corp, $header)) {
    echo "Email envoyé avec succès à $dest ...";
    var_dump(mail($dest, $sujet, $corp, $header));
} else {
